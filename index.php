...
$available_pages = ['login', 'register', 'logout', 'dashboard', 'profile','user/list', 'user/create', 'user/update', 'user/delete', 'user/report', 'user/attendance'];
$logged_in_pages = ['dashboard', 'profile'];
$non_logged_in_pages = ['login', 'register'];
$admin_pages = ['user/list','user/create', 'user/update', 'user/delete', 'user/report', 'user/attendance'];
